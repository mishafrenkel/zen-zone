  ...
  render() {
    ...
    return (
      <div className='wrapper'>
        ...
        <footer>
          {testval}
          <a href='https://twitter.com/mikebeingfrank' target='_blank'>@mikebeingfrank</a>

          {' '}
          | github:
          {' '}

          <a href='https://github.com' target='_blank'>mishafrenkel</a>

          {' '}
          | app repository:
          {' '}

          <a href='https://github.com/' target='_blank'>ZenTime</a>
        </footer>
      </div>
    );
  }
